      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <Link href={`/clients/${invoice.client.id}`} className="font-semibold text-gray-900 dark:text-white hover:text-[#4a7c59] text-lg">
              {invoice.client.name} →
            </Link>
          </div>
          ...
          <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
            ...
            <Link href={`/jobs/${invoice.job.id}`} className="font-semibold text-gray-900 dark:text-white hover:text-[#4a7c59] text-lg">
              {invoice.job.title} →
            </Link>
          </div>
      ...
      {invoice.job.convertedFromEstimate && (
        <div className="bg-blue-50 dark:bg-blue-900/20 border-2 border-blue-500 rounded-xl p-6">
          ...
          <div className="flex items-center space-x-3 text-sm">
            <Link href={`/estimates/${invoice.job.convertedFromEstimate.id}`} className="px-3 py-2 bg-white border border-blue-300 rounded-lg hover:bg-blue-50 dark:bg-blue-900/20">
              📋 Estimate: {invoice.job.convertedFromEstimate.title}
            </Link>
            <ArrowRight className="w-4 h-4 text-gray-400" />
            <Link href={`/jobs/${invoice.job.id}`} className="px-3 py-2 bg-white border border-blue-300 rounded-lg hover:bg-blue-50 dark:bg-blue-900/20">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm p-6">
        ...
        {invoice.payments.length > 0 ? (
          <div className="space-y-3">
            ...
            {/* Payment Summary */}
            <div className="mt-4 p-4 bg-gray-50 dark:bg-gray-700 rounded-lg border-2 border-gray-300">
              <div className="flex items-center justify-between">
