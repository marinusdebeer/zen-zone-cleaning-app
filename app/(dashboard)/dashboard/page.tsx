  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-gray-600 mt-1">Welcome back! Here's what's happening with {org.name} today.</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-l-blue-500">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              ...
              <p className="text-2xl font-bold text-gray-900 mt-2">{totalClients}</p>
              <div className="flex items-center mt-2">
                <span className="text-sm text-gray-500">{newClientsThisMonth} new this month</span>
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-l-purple-500">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-600">Visits This Week</p>
              <p className="text-2xl font-bold text-gray-900 mt-2">{visitsThisWeek}</p>
              <div className="flex items-center mt-2">
                <span className="text-sm text-gray-500">{completedVisitsThisWeek} completed</span>
              </div>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 border-l-4 border-l-orange-500">
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-600">Tomorrow's Visits</p>
              <p className="text-2xl font-bold text-gray-900 mt-2">{visitsTomorrow}</p>
              <div className="flex items-center mt-2">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="bg-gradient-to-br from-yellow-50 to-yellow-100 rounded-xl p-6 border border-yellow-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-yellow-800">Active Leads</p>
              <p className="text-3xl font-bold text-yellow-900 mt-2">{activeLeads}</p>
              <p className="text-xs text-yellow-700 mt-1">of {totalLeads} total</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-6 border border-green-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-green-800">Invoices Paid</p>
              <p className="text-3xl font-bold text-green-900 mt-2">{paidInvoices}</p>
              <p className="text-xs text-green-700 mt-1">of {totalInvoices} total</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-6 border border-red-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-xs text-red-700 mt-1">awaiting payment</p>
            </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-6">
            ...
            <div className="space-y-3">
              ...
              <Link 
                href="/leads"
                className="w-full flex items-center justify-center px-4 py-2.5 border-2 border-[#4a7c59] text-[#4a7c59] rounded-lg hover:bg-[#f7faf7] transition-colors font-medium"
              >
              ...
              <Link 
                href="/clients"
                className="w-full flex items-center justify-center px-4 py-2.5 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors font-medium"
              >
            ...
            <div className="space-y-4">
              {recentInvoices.slice(0, 2).map((invoice) => (
                <Link 
                  ...
                  className="flex items-start space-x-3 hover:bg-gray-50 p-2 rounded-lg transition-colors -m-2"
                >
              ...
              {recentClients.slice(0, 2).map((client) => (
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-gray-900 truncate">New client added</p>
                    <p className="text-xs text-gray-500 truncate">
