    ...
    <form id="client-form" action={handleSubmit} className="space-y-4">
      <div>
        ...
        <input
          ...
          id="name"
          required
          className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-brand focus:border-blue-500 sm:text-sm"
