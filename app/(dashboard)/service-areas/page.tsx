    ...
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-600 mt-1">Manage locations where you provide services</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-2">{activeAreas.length}</p>
            </div>
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-gray-900 mt-2">{totalJobs}</p>
            </div>
            <div className="p-3 bg-[#f7faf7] rounded-lg">
              <MapPin className="h-6 w-6 text-[#4a7c59]" />
            </div>
      ...
      <div className="bg-white rounded-xl shadow-sm p-6">
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            <p className="font-medium text-gray-900">Zen Zone Cleaning Services</p>
            <p className="text-gray-600 mt-1">49 High St Suite 300</p>
            <p className="text-gray-600">Barrie, ON L4N 5J4</p>
            <p className="text-gray-600">Canada 🇨🇦</p>
            <p className="text-gray-600 mt-2">(705) 242-1166</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm">
        <div className="p-6 border-b border-gray-200">
          <h2 className="text-lg font-semibold text-gray-900">All Service Areas</h2>
        </div>
        <div className="p-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {serviceAreas.map((area) => (
              <div key={area.id} className={`border rounded-lg p-6 transition-shadow ${area.active ? 'border-[#4a7c59] hover:shadow-lg' : 'border-gray-200 opacity-60'}`}>
                ...
                <div className="mt-4 space-y-2">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-medium text-gray-900">{area.postalCodes.join(', ')}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">Jobs Completed:</span>
                    <span className="font-medium text-gray-900">{area.jobs}</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-gray-600">Avg. Travel:</span>
                    <span className="font-medium text-gray-900">{area.avgTravelTime}</span>
                  </div>
                </div>
