...
export function AdminHeader() {
  ...
  return (
    <header className="bg-gradient-to-r from-[#0f172a] to-[#1e40af] border-b border-blue-900">
      <div className="px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            <div className="w-12 h-12 bg-gradient-to-br from-[#3b82f6] to-[#1e40af] rounded-xl flex items-center justify-center text-white font-bold text-xl shadow-lg">
              CF
            </div>
            <div>
              <h1 className="text-xl font-bold text-white">CleanFlow</h1>
              <p className="text-xs text-blue-200">Super Admin Dashboard</p>
            </div>
          </div>
          <div className="flex items-center space-x-4">
